...
test('CLI - Ingest default Issue #841 payload with table and json formatting', () => {
  ...
  assert.equal(parsedJson[0].evaluation.expectedValueSats, 126700);
  assert.equal(parsedJson[0].evaluation.winProbability, 0.181);
