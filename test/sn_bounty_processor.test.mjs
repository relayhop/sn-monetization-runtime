...
test('CLI - Ingest default Issue #835 payload with table and json formatting', () => {
  ...
  assert.equal(parsedJson[0].ageHours, 21.2);
  assert.equal(parsedJson[0].evaluation.expectedValueSats, 770);
});
