...
if (isMain) {
  ...
  if (rowArgIdx !== -1 && args[rowArgIdx + 1]) {
    ...
    tsvContent = `1559635\tAskSN\t2\t227\t1000\t2\t32.0\t1208996\t473\trecent@AskSN|recent@the_stacker_muse\tOPEN_BOUNTY,LOW_COMP\t🔥 THE QUESTION THAT ALMOST NO ONE DARES TO ANSWER`;
  }
