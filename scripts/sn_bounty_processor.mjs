...
if (isMain) {
  ...
  if (rowArgIdx !== -1 && args[rowArgIdx + 1]) {
    ...
    tsvContent = `1559635\tAskSN\t2\t158\t1000\t2\t8.4\t1208996\t472\trecent@AskSN|top@AskSN|recent@the_stacker_muse\tOPEN_BOUNTY,LOW_COMP,SIGNAL\t🔥 THE QUESTION THAT ALMOST NO ONE DARES TO ANSWER\n1558884\tStacker_Sports\t3\t1301\t2000\t11\t25.8\t54354\t6617\trecent@Stacker_Sports\tOPEN_BOUNTY,HOT,SELF_POST_OPP\tAFL Finals Week 2 Pick Em`;
  }
