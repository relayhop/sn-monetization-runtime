...
if (isMain) {
  ...
  if (rowArgIdx !== -1 && args[rowArgIdx + 1]) {
    ...
    tsvContent = '1566212\tnews\t2\t1259\t1000\t4\t14.6\t51481\t4215\trecent@news|top@news\tOPEN_BOUNTY,LOW_COMP,HOT\tIceberg Ahead - Finding the small news story before it changes the world';
  }
