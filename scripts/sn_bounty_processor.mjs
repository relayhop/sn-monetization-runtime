...
if (isMain) {
  ...
  if (rowArgIdx !== -1 && args[rowArgIdx + 1]) {
    ...
    // Default fallback: Issue 614 payload
    tsvContent = '1553226\tStacker_Stocks\t2\t35\t10000\t20\t17.7\t9274\t26623\trecent@Stacker_Stocks|top@Stacker_Stocks\tOPEN_BOUNTY\tDaily Stock Discussion Sunday’s Weekly Close Contest 🟥 or 🟩? 20k sat award!';
  }
