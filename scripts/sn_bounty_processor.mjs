...
if (isMain) {
  ...
  if (rowArgIdx !== -1 && args[rowArgIdx + 1]) {
    ...
    // Default fallback: Issue 751 payload
    tsvContent = '1558286\tStacker_Stocks\t2\t31\t10000\t0\t0.6\t9274\t26852\trecent@Stacker_Stocks|top@Stacker_Stocks\tOPEN_BOUNTY,LOW_COMP,FRESH\tDaily Stock Discussion Sunday’s Weekly Close Contest 🟥 or 🟩?  20k sat award';
  }
