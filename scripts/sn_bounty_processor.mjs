...
if (isMain) {
  ...
  if (rowArgIdx !== -1 && args[rowArgIdx + 1]) {
    ...
    tsvContent = `1558884\tStacker_Sports\t3\t714\t2000\t8\t3.8\t54354\t6617\trecent@Stacker_Sports|top@Stacker_Sports\tOPEN_BOUNTY,SIGNAL,SELF_POST_OPP\tAFL Finals Week 2 Pick Em
