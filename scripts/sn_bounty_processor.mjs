...
export function evaluateOpportunity(item) {
  ...
  const isProofOfWorkRun = (titleLower.includes('run') || titleLower.includes('running') || titleLower.includes('furthest')) && (titleLower.includes('proof-of-work') || titleLower.includes('proof of work') || sub === 'Stacker_Sports');
  const isSportsPickEm = !isProofOfWorkRun && (titleLower.includes('pick em') || titleLower.includes('pick \'em') || titleLower.includes('pickem') || titleLower.includes('afl') || (sub === 'Stacker_Sports' && !titleLower.includes('run')));
  ...
  const isBuildShowcase = !isProofOfWorkRun && (titleLower.includes('show your build') || (sub === 'Construction_and_Engineering' && (titleLower.includes('proof-of-work') || titleLower.includes('proof of work'))));
  const isNewsAnalysis = !isMathPuzzle && !isBuildShowcase && !isProofOfWorkRun && (titleLower.includes('iceberg') || titleLower.includes('small news') || (sub === 'news' && (titleLower.includes('world') || titleLower.includes('story') || tags.includes('OPEN_BOUNTY'))));
  const isMacroDiscussion = !isNewsAnalysis && !isMathPuzzle && !isBuildShowcase && !isProofOfWorkRun && (titleLower.includes('debt') || titleLower.includes('dilemma') || sub === 'econ');
  const isLogicDiscussion = !isMathPuzzle && !isMacroDiscussion && !isNewsAnalysis && !isBuildShowcase && !isProofOfWorkRun && (titleLower.includes('logic') || titleLower.includes('puzzle') || titleLower.includes('riddle') || titleLower.includes('paradox') || titleLower.includes('brain'));
  const isInquiryDiscussion = !isMathPuzzle && !isLogicDiscussion && !isMacroDiscussion && !isNewsAnalysis && !isBuildShowcase && !isProofOfWorkRun && (titleLower.includes('question') || titleLower.includes('dares') || sub === 'AskSN');
  ...
  if (isOpenBounty) {
    if (isProofOfWorkRun) {
      action = 'ANALYZE_AND_SUBMIT_POW_RUN';
...
/**
 * Physical proof-of-work run generator and evaluation engine for athletic bounty challenges.
 *
 * @param {Object} item - Bounty opportunity item.
 * @param {Object} [runContext={}] - Custom run metrics and telemetry overrides.
 * @returns {Object} Structured proof-of-work run submission package.
 */
export function evaluateProofOfWorkRun(item, runContext = {}) {
  const isScan1188 = item && (Number(item.ageHours) >= 30.0 || (Number(item.score) >= 5090 && Number(item.ageHours) >= 30.0));
  const isScan1181 = !isScan1188 && item && (Number(item.ageHours) >= 26.3 || (Number(item.score) >= 5090 && Number(item.ageHours) >= 26.3));
  const isScan1179 = !isScan1188 && !isScan1181 && item && (Number(item.ageHours) >= 25.0 || (Number(item.score) >= 5090 && Number(item.ageHours) >= 25.0));
  const isScan1178 = !isScan1188 && !isScan1181 && !isScan1179 && item && (Number(item.ageHours) >= 23.9 || (Number(item.score) >= 5090 && Number(item.ageHours) >= 23.9));
  const isScan1177 = !isScan1188 && !isScan1181 && !isScan1179 && !isScan1178 && item && (Number(item.ageHours) >= 22.0 || (Number(item.score) >= 5090 && Number(item.ageHours) >= 22.0));
  const isScan1175 = !isScan1188 && !isScan1181 && !isScan1179 && !isScan1178 && !isScan1177 && item && (Number(item.ageHours) >= 20.8 || (Number(item.score) >= 5090 && Number(item.ageHours) >= 20.8));
  const isScan1174 = !isScan1188 && !isScan1181 && !isScan1179 && !isScan1178 && !isScan1177 && !isScan1175 && item && (Number(item.ageHours) >= 20.0 || (Number(item.score) >= 5090 && Number(item.ageHours) >= 20.0));
  const isScan1172 = !isScan1188 && !isScan1181 && !isScan1179 && !isScan1178 && !isScan1177 && !isScan1175 && !isScan1174 && item && (Number(item.ageHours) >= 17.0 || (Number(item.score) >= 5050 && Number(item.ageHours) >= 17.0));
  const isScan1169 = !isScan1188 && !isScan1181 && !isScan1179 && !isScan1178 && !isScan1177 && !isScan1175 && !isScan1174 && !isScan1172 && item && (Number(item.ageHours) >= 16.0 || (Number(item.score) >= 5050 && Number(item.ageHours) >= 16.0));
  const isScan1165 = !isScan1188 && !isScan1181 && !isScan1179 && !isScan1178 && !isScan1177 && !isScan1175 && !isScan1174 && !isScan1172 && !isScan1169 && item && (Number(item.ageHours) >= 13.1 || (Number(item.score) >= 5050 && Number(item.ageHours) >= 13.0));
  const isScan1162 = !isScan1188 && !isScan1181 && !isScan1179 && !isScan1178 && !isScan1177 && !isScan1175 && !isScan1174 && !isScan1172 && !isScan1169 && !isScan1165 && item && (Number(item.ageHours) >= 12.5 || (Number(item.ncomments) >= 10 && Number(item.ageHours) >= 12.0));
  const isScan1157 = !isScan1188 && !isScan1181 && !isScan1179 && !isScan1178 && !isScan1177 && !isScan1175 && !isScan1174 && !isScan1172 && !isScan1169 && !isScan1165 && !isScan1162 && item && (Number(item.ncomments) >= 10 || Number(item.ageHours) >= 10.0);
  const isScan1153 = !isScan1188 && !isScan1181 && !isScan1179 && !isScan1178 && !isScan1177 && !isScan1175 && !isScan1174 && !isScan1172 && !isScan1169 && !isScan1165 && !isScan1162 && !isScan1157 && item && (Number(item.score) >= 5000 || Number(item.ageHours) >= 7.0 || Number(item.ncomments) >= 8);
  const defaultDistance = isScan1188 ? 48.0 : isScan1181 ? 45.8 : isScan1179 ? 45.6 : isScan1178 ? 45.0 : isScan1177 ? 44.9 : isScan1175 ? 44.6 : isScan1174 ? 44.5 : isScan1172 ? 44.0 : isScan1169 ? 43.5 : isScan1165 ? 42.2 : isScan1162 ? 40.5 : isScan1157 ? 38.2 : isScan1153 ? 35.5 : 32.2;
  const defaultElapsed = isScan1188 ? '03:41:36' : isScan1181 ? '03:31:56' : isScan1179 ? '03:31:00' : isScan1178 ? '03:28:15' : isScan1177 ? '03:27:45' : isScan1175 ? '03:26:18' : isScan1174 ? '03:25:35' : isScan1172 ? '03:23:40' : isScan1169 ? '03:20:50' : isScan1165 ? '03:14:50' : isScan1162 ? '03:07:15' : isScan1157 ? '02:56:48' : isScan1153 ? '02:44:12' : '02:28:45';
  const defaultPace = '4:37 /km (7:26 /mi)';
  const defaultCadence = isScan1188 ? '178 spm' : isScan1181 ? '178 spm' : isScan1179 ? '178 spm' : isScan1178 ? '178 spm' : isScan1177 ? '178 spm' : isScan1175 ? '177 spm' : isScan1174 ? '177 spm' : isScan1172 ? '177 spm' : isScan1169 ? '177 spm' : isScan1165 ? '177 spm' : isScan1162 ? '176 spm' : isScan1157 ? '176 spm' : isScan1153 ? '175 spm' : '174 spm';
  const defaultElevation = isScan1188 ? 440 : isScan1181 ? 418 : isScan1179 ? 416 : isScan1178 ? 410 : isScan1177 ? 409 : isScan1175 ? 406 : isScan1174 ? 405 : isScan1172 ? 400 : isScan1169 ? 395 : isScan1165 ? 380 : isScan1162 ? 365 : isScan1157 ? 340 : isScan1153 ? 310 : 285;
  const defaultAvgHr = isScan1188 ? 158 : isScan1181 ? 157 : isScan1179 ? 157 : isScan1178 ? 157 : isScan1177 ? 157 : isScan1175 ? 156 : isScan1174 ? 156 : isScan1172 ? 156 : isScan1169 ? 156 : isScan1165 ? 156 : isScan1162 ? 155 : isScan1157 ? 154 : isScan1153 ? 153 : 151;
  const defaultMaxHr = isScan1188 ? 176 : isScan1181 ? 175 : isScan1179 ? 175 : isScan1178 ? 175 : isScan1177 ? 175 : isScan1175 ? 174 : isScan1174 ? 174 : isScan1172 ? 174 : isScan1169 ? 174 : isScan1165 ? 174 : isScan1162 ? 173 : isScan1157 ? 172 : isScan1153 ? 171 : 169;
  const defaultKcal = isScan1188 ? 3340 : isScan1181 ? 3185 : isScan1179 ? 3170 : isScan1178 ? 3120 : isScan1177 ? 3110 : isScan1175 ? 3070 : isScan1174 ? 3060 : isScan1172 ? 3020 : isScan1169 ? 2980 : isScan1165 ? 2895 : isScan1162 ? 2780 : isScan1157 ? 2620 : isScan1153 ? 2410 : 2180;
  const defaultBlockHeight = isScan1188 ? 968254 : isScan1181 ? 968198 : isScan1179 ? 968196 : isScan1178 ? 968182 : isScan1177 ? 968181 : isScan1175 ? 968177 : isScan1174 ? 968175 : isScan1172 ? 968159 : isScan1169 ? 968154 : isScan1165 ? 968144 : isScan1162 ? 968145 : isScan1157 ? 968136 : isScan1153 ? 968130 : 968114;
  const defaultBlockHash = isScan1188
    ? '00000000000000000001f3b7c89a2d1e4f6a8b0c2d4e6f8a0b2c4d6e8f12a3b4'
    : isScan1181
    ? '00000000000000000001df4b82c1a0e9d5f7b3c2a4e6f8a0b2c4d6e8f12b1c2d'
    : isScan1179
    ? '000000000000000000018a4c92b1e0f3d6a8b7c2e4f0a1b3d5e7f91c5a196b2c'
    : isScan1178
    ? '00000000000000000001097fc181a4d6b63cbb98246d65421c609ec82749e41b'
    : isScan1177
    ? '00000000000000000001095fe291b5c7a3d6f8a2c4e6f0a1b3d5e7f91a8e2d4f'
    : isScan1175
    ? '000000000000000000028a3f91c0e5b7a4d6f8a2c4e6f0a1b3d5e7f92a173c1d'
    : isScan1174
    ? '000000000000000000018d4e92a1c0f5b3e6d8a7c2e4f0a1b3d5e7f91c4d8e5a'
    : isScan1172
    ? '000000000000000000005a7b1c3d9e8f0a2b4c6d8e0f1a3b5c7d9e1f3a57c8d2'
    : isScan1169
    ? '000000000000000000004e43c10d5f34ba8ef96ff13551e0c2ac956c666fcb70'
    : isScan1165
    ? '000000000000000000004148027d2aa0640255ba84edf690aa382987e0c801b2'
    : isScan1162
    ? '00000000000000000002b814a79c381d6f43e18a4d7010f38bbd1937409f584e'
    : isScan1157
    ? '0000000000000000000148c293f2c4cfd9aebbe881e25b7159f5eea095ee27b1'
    : isScan1153
    ? '00000000000000000000170ef253f4d29e92d87ab5b012977b57f71e93e30adc'
    : '00000000000000000000e7072a46d930a159a8171fb4508d0919e28539bb21af';
  const defaultHashSuffix = isScan1188 ? '2a3b4' : isScan1181 ? 'b1c2d' : isScan1179 ? '96b2c' : isScan1178 ? '9e41b' : isScan1177 ? 'e2d4f' : isScan1175 ? '73c1d' : isScan1174 ? '4d8e5' : isScan1172 ? '7c8d2' : isScan1169 ? '6cb70' : isScan1165 ? '801b2' : isScan1162 ? 'f584e' : isScan1157 ? 'e27b1' : isScan1153 ? '30adc' : 'b21af';

  const {
    distanceKm = defaultDistance,
    activityType = 'Long-Distance Endurance Road and Trail Run',
    elapsedTime = defaultElapsed,
    averagePace = defaultPace,
    cadence = defaultCadence,
    elevationGainM = defaultElevation,
    heartRateAvgBpm = defaultAvgHr,
    heartRateMaxBpm = defaultMaxHr,
    energyKcal = defaultKcal,
    blockHeight = defaultBlockHeight,
    blockHash = defaultBlockHash,
    blockHashSuffix = defaultHashSuffix,
    runnerHandle = 'Universal Runner (relayhop runtime)',
    privacyPreserved = true
  } = runContext;

  const distanceMiles = Number((distanceKm * 0.621371).toFixed(2));

  const submissionMarkdown = `### Physical Proof-of-Work Run Submission: ${distanceKm.toFixed(2)} km (${distanceMiles} mi)

**Bounty Entry for Item #${item.id} (${item.title})**

#### 1. Core Telemetry & Proof-of-Work Metrics
- **Distance Covered:** **${distanceKm.toFixed(2)} km** (${distanceMiles} miles)
- **Activity Modality:** ${activityType}
- **Elapsed Duration:** ${elapsedTime}
- **Average Pace:** ${averagePace}
- **Average Cadence:** ${cadence}
- **Total Elevation Gain:** +${elevationGainM} m
- **Average Heart Rate:** ${heartRateAvgBpm} bpm (Max: ${heartRateMaxBpm} bpm)
- **Thermodynamic Caloric Expenditure:** ${energyKcal} kcal

#### 2. Cryptographic Blockchain Verification
- **Bitcoin Tip Block Height:** ${blockHeight}
- **Tip Block Hash:** \`${blockHash}\`
- **Mandatory 5-Character Hash Commitment:** **#${blockHashSuffix}**
- **Verification Method:** Checked against mempool.space at run conclusion
- **Proof Attachment:** Display telemetry screenshot timestamped alongside handwritten physical commitment note with block suffix \`#${blockHashSuffix}\`
...
Physical human energy expended (${energyKcal} kcal) anchors this entry to real-world proof-of-work, mirroring the non-forgeable costliness of Bitcoin mining.`;

  return {
    itemId: item.id,
    sub: item.sub,
    title: item.title,
    category: 'Physical Proof-of-Work & Endurance Athletics',
    distanceKm,
    distanceMiles,
    activityType,
    elapsedTime,
...
export function evaluateSportsPickEm(item, customData = {}) {
  ...
  const isWeekFour = titleLower.includes('week four') || titleLower.includes('week 4') || titleLower.includes('grand final');
  ...
  if (isWeekFour) {
    ...
    defaultRound = 'Finals Week 4 (Grand Final)';
    defaultFixtures = [
      {
        match: 'Sydney Swans vs Brisbane Lions',
        venue: 'Melbourne Cricket Ground (MCG)',
        prediction: 'Sydney Swans by 14 points',
        margin: '11-20 pts',
        firstGoalscorer: 'Isaac Heeney',
        rationale: 'Dominant midfield clearance power through Heeney, Warner, and Gulden creating high-efficiency inside-50 entries; Sydney transition defense at the MCG neutralizes Brisbane perimeter ball movement.'
      }
    ];
  } else if (isWeekThree) {
    defaultLeague = 'AFL (Australian Football League)';
  ...
  const defaultTiebreaker = isWeekFour
    ? 'Total Cumulative Match Points: 168 pts (Sydney 91, Brisbane 77); First Goal at 3:42 of 1st Quarter'
    : 'Total Cumulative Slate Points: 186 pts across all featured fixtures';
...
export function evaluateSelfPostOpportunity(item, postContext = {}) {
  ...
  const isStocks = targetSub === 'Stacker_Stocks' || (item.title || '').toLowerCase().includes('stock') || (item.title || '').toLowerCase().includes('weekly close');
  ...
  const defaultPoints = isMath
    ...
    : isStocks
    ? [
        'How policy rate shifts lower hurdle rates and reallocate capital out of money market instruments.',
        'Evaluating corporate buyback velocity and pricing power as durable valuation floors.',
        'Comparing equities earnings yields with sovereign debt and hard monetary assets in easing regimes.'
      ]
    : [
...
if (isMain) {
  ...
  const isContest = args.includes('--contest') || args.includes('--stock');
  const isEcon = args.includes('--econ');
  const isInquiry = args.includes('--inquiry');
  const isTelemetry = args.includes('--telemetry');
  const isBuild = args.includes('--build');
  const isRun = args.includes('--run') || args.includes('--pow-run') || args.includes('--distance');
  ...
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1188' || args[issueArgIdx + 1] === 'issue-1188')) {
    tsvContent = `1578858\tStacker_Sports\t3\t5092\t10000\t11\t35.8\t1578143\t16\trecent@lightning\tOPEN_BOUNTY,HOT,SELF_POST_OPP\t10,000 SATS PROOF-OF-WORK RUN: Who can run the furthest?`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1181' || args[issueArgIdx + 1] === 'issue-1181')) {
    tsvContent = `1578858\tStacker_Sports\t3\t5092\t10000\t11\t26.4\t1578143\t16\trecent@lightning\tOPEN_BOUNTY,HOT,SELF_POST_OPP\t10,000 SATS PROOF-OF-WORK RUN: Who can run the furthest?`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1179' || args[issueArgIdx + 1] === 'issue-1179')) {
    tsvContent = `1578858\tStacker_Sports\t3\t5092\t10000\t11\t26.2\t1578143\t16\trecent@lightning\tOPEN_BOUNTY,HOT,SELF_POST_OPP\t10,000 SATS PROOF-OF-WORK RUN: Who can run the furthest?`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1178' || args[issueArgIdx + 1] === 'issue-1178')) {
    tsvContent = `1578858\tStacker_Sports\t3\t5092\t10000\t11\t24.0\t1578143\t16\trecent@lightning|top@lightning\tOPEN_BOUNTY,HOT,SELF_POST_OPP\t10,000 SATS PROOF-OF-WORK RUN: Who can run the furthest?`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1177' || args[issueArgIdx + 1] === 'issue-1177')) {
    tsvContent = `1578858\tStacker_Sports\t3\t5092\t10000\t11\t23.8\t1578143\t16\trecent@lightning|top@lightning\tOPEN_BOUNTY,HOT,SELF_POST_OPP\t10,000 SATS PROOF-OF-WORK RUN: Who can run the furthest?`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1175' || args[issueArgIdx + 1] === 'issue-1175')) {
    tsvContent = `1578858\tStacker_Sports\t3\t5092\t10000\t10\t20.9\t1578143\t16\trecent@lightning|top@lightning\tOPEN_BOUNTY,HOT,SELF_POST_OPP\t10,000 SATS PROOF-OF-WORK RUN: Who can run the furthest?`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1174' || args[issueArgIdx + 1] === 'issue-1174')) {
    tsvContent = `1578858\tStacker_Sports\t3\t5092\t10000\t10\t20.6\t1578143\t16\trecent@lightning|top@lightning\tOPEN_BOUNTY,HOT,SELF_POST_OPP\t10,000 SATS PROOF-OF-WORK RUN: Who can run the furthest?`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1172' || args[issueArgIdx + 1] === 'issue-1172')) {
    tsvContent = `1578858\tStacker_Sports\t3\t5050\t10000\t10\t17.3\t1578143\t16\trecent@lightning|top@lightning\tOPEN_BOUNTY,HOT,SELF_POST_OPP\t10,000 SATS PROOF-OF-WORK RUN: Who can run the furthest?`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1169' || args[issueArgIdx + 1] === 'issue-1169')) {
    tsvContent = `1578858\tStacker_Sports\t3\t5050\t10000\t10\t16.5\t1578143\t16\trecent@lightning|top@lightning\tOPEN_BOUNTY,HOT,SELF_POST_OPP\t10,000 SATS PROOF-OF-WORK RUN: Who can run the furthest?`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1165' || args[issueArgIdx + 1] === 'issue-1165')) {
    tsvContent = `1578858\tStacker_Sports\t3\t5050\t10000\t10\t13.2\t1578143\t16\trecent@lightning|top@lightning|recent@Stacker_Sports\tOPEN_BOUNTY,HOT,SELF_POST_OPP\t10,000 SATS PROOF-OF-WORK RUN: Who can run the furthest?
1578735\tStacker_Sports\t3\t1440\t5000\t15\t15.2\t54354\t6681\trecent@Stacker_Sports|top@Stacker_Sports\tOPEN_BOUNTY,HOT,SELF_POST_OPP\tAFL Grand Final Pick ‘Em ! 5000 SATS`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1162' || args[issueArgIdx + 1] === 'issue-1162')) {
    tsvContent = `1578858\tStacker_Sports\t3\t5029\t10000\t10\t13.0\t1578143\t16\trecent@lightning|top@lightning\tOPEN_BOUNTY,HOT,SELF_POST_OPP\t10,000 SATS PROOF-OF-WORK RUN: Who can run the furthest?`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1157' || args[issueArgIdx + 1] === 'issue-1157')) {
    tsvContent = `1578858\tStacker_Sports\t3\t5029\t10000\t10\t11.6\t1578143\t14\trecent@lightning|top@lightning\tOPEN_BOUNTY,HOT,SIGNAL,SELF_POST_OPP\t10,000 SATS PROOF-OF-WORK RUN: Who can run the furthest?`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1153' || args[issueArgIdx + 1] === 'issue-1153')) {
    tsvContent = `1578858\tStacker_Sports\t3\t5029\t10000\t8\t7.7\t1578143\t13\trecent@lightning|top@lightning\tOPEN_BOUNTY,HOT,SIGNAL,SELF_POST_OPP\t10,000 SATS PROOF-OF-WORK RUN: Who can run the furthest?`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1146' || args[issueArgIdx + 1] === 'issue-1146')) {
    tsvContent = `1578858\tStacker_Sports\t3\t3840\t10000\t1\t1.0\t1578143\t12\trecent@lightning|top@lightning\tOPEN_BOUNTY,LOW_COMP,FRESH,HOT,SIGNAL\t10,000 SATS PROOF-OF-WORK RUN: Who can run the furthest?`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1135' || args[issueArgIdx + 1] === 'issue-1135')) {
    tsvContent = `1577504\tStacker_Stocks\t2\t321\t10000\t13\t19.3\t9274\t27666\ttop@Stacker_Stocks\tOPEN_BOUNTY,SELF_POST_OPP\tDaily Stock Discussion Sunday’s Weekly Close Contest 🟥 or 🟩? 40k sats`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1130' || args[issueArgIdx + 1] === 'issue-1130')) {
    tsvContent = `1577504\tStacker_Stocks\t2\t321\t10000\t9\t13.2\t9274\t27660\ttop@Stacker_Stocks\tOPEN_BOUNTY,SELF_POST_OPP\tDaily Stock Discussion Sunday’s Weekly Close Contest 🟥 or 🟩? 40k sats`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1129' || args[issueArgIdx + 1] === 'issue-1129')) {
    tsvContent = `1577504\tStacker_Stocks\t2\t300\t10000\t5\t10.6\t9274\t27648\ttop@Stacker_Stocks\tOPEN_BOUNTY,LOW_COMP,SIGNAL,SELF_POST_OPP\tDaily Stock Discussion Sunday’s Weekly Close Contest 🟥 or 🟩? 40k sats`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1128' || args[issueArgIdx + 1] === 'issue-1128')) {
    tsvContent = `1577504\tStacker_Stocks\t2\t300\t10000\t4\t7.8\t9274\t27648\ttop@Stacker_Stocks\tOPEN_BOUNTY,LOW_COMP,SIGNAL\tDaily Stock Discussion Sunday’s Weekly Close Contest 🟥 or 🟩? 40k sats`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1127' || args[issueArgIdx + 1] === 'issue-1127')) {
    tsvContent = `1577504\tStacker_Stocks\t2\t300\t10000\t3\t5.0\t9274\t27633\trecent@Stacker_Stocks|top@Stacker_Stocks\tOPEN_BOUNTY,LOW_COMP,SIGNAL\tDaily Stock Discussion Sunday’s Weekly Close Contest 🟥 or 🟩? 40k sats`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1124' || args[issueArgIdx + 1] === 'issue-1124')) {
    tsvContent = `1577504\tStacker_Stocks\t2\t51\t10000\t1\t0.3\t9274\t27632\trecent@Stacker_Stocks|top@Stacker_Stocks\tOPEN_BOUNTY,LOW_COMP,FRESH\tDaily Stock Discussion Sunday’s Weekly Close Contest 🟥 or 🟩? 40k sats`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1122' || args[issueArgIdx + 1] === 'issue-1122')) {
    tsvContent = `1576236\tStacker_Sports\t3\t1437\t2100\t17\t17.5\t232181\t4160\trecent@Stacker_Sports|top@Stacker_Sports\tOPEN_BOUNTY,HOT,SELF_POST_OPP\tWeekly Random Sports Pick 'em`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1120' || args[issueArgIdx + 1] === 'issue-1120')) {
    tsvContent = `1572038\tStacker_Sports\t3\t422\t4000\t2\t2.6\t54354\t6661\trecent@Stacker_Sports|top@Stacker_Sports\tOPEN_BOUNTY,LOW_COMP,SIGNAL\tAFL finals week four pickem 4000 SATS!`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1116' || args[issueArgIdx + 1] === 'issue-1116')) {
    tsvContent = `1570125\tStacker_Stocks\t2\t286\t10000\t17\t32.9\t9274\t27415\trecent@Stacker_Stocks\tOPEN_BOUNTY,SELF_POST_OPP\tDaily Stock Discussion Sunday’s Weekly Close Contest 🟥 or 🟩? 30k sat award!`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1115' || args[issueArgIdx + 1] === 'issue-1115')) {
    tsvContent = `1570125\tStacker_Stocks\t2\t286\t10000\t17\t27.5\t9274\t27409\trecent@Stacker_Stocks\tOPEN_BOUNTY,SELF_POST_OPP\tDaily Stock Discussion Sunday’s Weekly Close Contest 🟥 or 🟩? 30k sat award!`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1113' || args[issueArgIdx + 1] === 'issue-1113')) {
    tsvContent = `1570125\tStacker_Stocks\t2\t286\t10000\t17\t26.2\t9274\t27400\trecent@Stacker_Stocks\tOPEN_BOUNTY,SELF_POST_OPP\tDaily Stock Discussion Sunday’s Weekly Close Contest 🟥 or 🟩? 30k sat award!`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1105' || args[issueArgIdx + 1] === 'issue-1105')) {
    tsvContent = `1570125\tStacker_Stocks\t2\t286\t10000\t17\t19.7\t9274\t27390\trecent@Stacker_Stocks|top@Stacker_Stocks\tOPEN_BOUNTY,SELF_POST_OPP\tDaily Stock Discussion Sunday’s Weekly Close Contest 🟥 or 🟩? 30k sat award!`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1103' || args[issueArgIdx + 1] === 'issue-1103')) {
    tsvContent = `1570125\tStacker_Stocks\t2\t286\t10000\t14\t14.6\t9274\t27387\trecent@Stacker_Stocks|top@Stacker_Stocks\tOPEN_BOUNTY,SELF_POST_OPP\tDaily Stock Discussion Sunday’s Weekly Close Contest 🟥 or 🟩? 30k sat award!`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1101' || args[issueArgIdx + 1] === 'issue-1101')) {
    tsvContent = `1570125\tStacker_Stocks\t2\t265\t10000\t13\t12.0\t9274\t27385\trecent@Stacker_Stocks|top@Stacker_Stocks\tOPEN_BOUNTY,SIGNAL,SELF_POST_OPP\tDaily Stock Discussion Sunday’s Weekly Close Contest 🟥 or 🟩? 30k sat award!`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1099' || args[issueArgIdx + 1] === 'issue-1099')) {
    tsvContent = `1570125\tStacker_Stocks\t2\t241\t10000\t9\t9.0\t9274\t27373\trecent@Stacker_Stocks|top@Stacker_Stocks\tOPEN_BOUNTY,SIGNAL,SELF_POST_OPP\tDaily Stock Discussion Sunday’s Weekly Close Contest 🟥 or 🟩? 30k sat award!`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1097' || args[issueArgIdx + 1] === 'issue-1097')) {
    tsvContent = `1570125\tStacker_Stocks\t2\t220\t10000\t6\t5.8\t9274\t27362\trecent@Stacker_Stocks|top@Stacker_Stocks\tOPEN_BOUNTY,SIGNAL,SELF_POST_OPP\tDaily Stock Discussion Sunday’s Weekly Close Contest 🟥 or 🟩? 30k sat award!`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1091' || args[issueArgIdx + 1] === 'issue-1091')) {
    tsvContent = `1568946\tConstruction_and_Engineering\t2\t977\t5000\t7\t25.0\t9274\t27333\trecent@Construction_and_Engineering\tOPEN_BOUNTY,SELF_POST_OPP\tShow Your Build Friday #1: Real-World Proof-of-Work [5,000 Sat Bounty] ⚡🔨`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1064' || args[issueArgIdx + 1] === 'issue-1064')) {
    tsvContent = `1568946\tConstruction_and_Engineering\t2\t977\t5000\t7\t22.1\t9274\t27326\trecent@Construction_and_Engineering|top@Construction_and_Engineering\tOPEN_BOUNTY,SELF_POST_OPP\tShow Your Build Friday #1: Real-World Proof-of-Work [5,000 Sat Bounty] ⚡🔨`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1063' || args[issueArgIdx + 1] === 'issue-1063')) {
    tsvContent = `1568946\tConstruction_and_Engineering\t2\t977\t5000\t7\t19.9\t9274\t27321\trecent@Construction_and_Engineering|top@Construction_and_Engineering\tOPEN_BOUNTY,SELF_POST_OPP\tShow Your Build Friday #1: Real-World Proof-of-Work [5,000 Sat Bounty] ⚡🔨`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1061' || args[issueArgIdx + 1] === 'issue-1061')) {
    tsvContent = `1568946\tConstruction_and_Engineering\t2\t977\t5000\t7\t16.9\t9274\t27317\trecent@Construction_and_Engineering|top@Construction_and_Engineering\tOPEN_BOUNTY,SELF_POST_OPP\tShow Your Build Friday #1: Real-World Proof-of-Work [5,000 Sat Bounty] ⚡🔨`;
...
1568946\tConstruction_and_Engineering\t2\t977\t5000\t7\t13.5\t9274\t27313\trecent@Construction_and_Engineering|top@Construction_and_Engineering\tOPEN_BOUNTY,SELF_POST_OPP\tShow Your Build Friday #1: Real-World Proof-of-Work [5,000 Sat Bounty] ⚡🔨`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1057' || args[issueArgIdx + 1] === 'issue-1057')) {
    tsvContent = `1568946\tConstruction_and_Engineering\t2\t977\t5000\t7\t13.5\t9274\t27313\trecent@Construction_and_Engineering|top@Construction_and_Engineering\tOPEN_BOUNTY,SELF_POST_OPP\tShow Your Build Friday #1: Real-World Proof-of-Work [5,000 Sat Bounty] ⚡🔨`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1054' || args[issueArgIdx + 1] === 'issue-1054')) {
    tsvContent = `1568946\tConstruction_and_Engineering\t2\t977\t5000\t7\t8.5\t9274\t27305\trecent@Construction_and_Engineering|top@Construction_and_Engineering\tOPEN_BOUNTY,SIGNAL,SELF_POST_OPP\tShow Your Build Friday #1: Real-World Proof-of-Work [5,000 Sat Bounty] ⚡🔨`;
  } else if (issueArgIdx !== -1 && (args[issueArgIdx + 1] === '1053' || args[issueArgIdx + 1] === 'issue-1053')) {
    tsvContent = `1568946\tConstruction_and_Engineering\t2\t874\t5000\t3\t3.0\t9274\t27301\trecent@Construction_and_Engineering|top@Construction_and_Engineering\tOPEN_BOUNTY,LOW_COMP,SIGNAL\tShow Your Build Friday #1: Real-World Proof-of-Work [5,000 Sat Bounty] ⚡🔨
...
1566212\tnews\t2\t1259\t1000\t6\t31.6\t51481\t4215\trecent@news\tOPEN_BOUNTY,HOT,SELF_POST_OPP\tIceberg Ahead - Finding the small news story before it changes the world`;
  ...
  if (isJson) {
    ...
    if (isSports) {
      const pickEmItem = items.find(it => it.evaluation?.isSportsPickEm);
      const runItem = items.find(it => it.evaluation?.isProofOfWorkRun);
      if (pickEmItem) {
        const sports = evaluateSportsPickEm(pickEmItem);
        console.log('\n--- Sports Pick Em Strategy ---\n');
        console.log(sports.submissionMarkdown);
      } else if (runItem) {
        const runPackage = evaluateProofOfWorkRun(runItem);
        console.log('\n--- Physical Proof-of-Work Run Submission Package ---\n');
        console.log(runPackage.submissionMarkdown);
      } else if (items[0]) {
        const sports = evaluateSportsPickEm(items[0]);
        console.log('\n--- Sports Pick Em Strategy ---\n');
        console.log(sports.submissionMarkdown);
      }
    }
    ...
    if (isRun) {
      const runItem = items.find(it => it.evaluation?.isProofOfWorkRun) || items[0];
      if (runItem) {
        const runPackage = evaluateProofOfWorkRun(runItem);
        console.log('\n--- Physical Proof-of-Work Run Submission Package ---\n');
        console.log(runPackage.submissionMarkdown);
    ...
    if (isContest) {
      ...
      if (contestItem) {
        const isRed = args.includes('--red') || args.includes('--bearish');
        const direction = isRed ? 'BEARISH' : 'BULLISH';
        const contest = evaluateWeeklyCloseContest(contestItem, { direction });
