...
#### 7. Formal Bounty Resolution Verdict
- ${bountyVerdict}
...
if (isMain) {
  ...
  if (rowArgIdx !== -1 && args[rowArgIdx + 1]) {
    ...
    tsvContent = `1567486\tmath\t2\t5944\t700000\t25\t2.0\t48657\t15192\trecent@math|top@math\tOPEN_BOUNTY,HOT,SIGNAL\t[Math Puzzle] Does every sequence terminate in a loop?
