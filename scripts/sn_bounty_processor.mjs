...
if (isMain) {
  ...
  if (rowArgIdx !== -1 && args[rowArgIdx + 1]) {
    ...
    // Default fallback: Issue 756 payload
    tsvContent = `1558562\tAskSN\t2\t215\t1000\t3\t4.4\t1208996\t471\trecent@econ|top@econ|recent@AskSN\tOPEN_BOUNTY,LOW_COMP,SIGNAL\tThe debt dilemma💸📈
