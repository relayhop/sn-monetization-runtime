...
export const SUB_ANGLE = {
  ...
  Stacker_Stocks: 'macro market analysis, technical equity setups, earnings catalysts, weekly close forecasts',
  Stacker_Sports: 'statistical probability, game outcome modeling',
};
