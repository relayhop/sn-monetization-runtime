...
export const SUB_ANGLE = {
  ...
  Stacker_Stocks: 'macroeconomic trends, equity earnings, market indicators, Sunday weekly close',
  Stacker_Sports: 'sports analytics, prediction markets, betting theory',
};
