...
export const SUB_ANGLE = {
  ...
  Stacker_Stocks: 'financial analysis, equity valuations, macro trends, weekly close analysis',
  Stacker_Sports: 'sports analytics, prediction markets, game statistics',
